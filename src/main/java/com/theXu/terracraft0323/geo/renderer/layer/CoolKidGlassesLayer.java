package com.theXu.terracraft0323.geo.renderer.layer;
...
import com.theXu.terracraft0323.geo.renderer.CoolKidRenderer;
...
public class CoolKidGlassesLayer extends GeoRenderLayer<CoolKidEntity> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(NeoMod.MODID, "textures/entity/cool_kid_glasses.png");
