...
import com.theXu.terracraft0323.geo.renderer.armor.GeckoArmorRenderer;
...
public final class GeckoArmorItem extends ArmorItem implements GeoItem {
	...
	public GeckoArmorItem(Holder<ArmorMaterial> armorMaterial, Type type, Properties properties) {
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
		controllers.add(new AnimationController<>(this, 20, state -> {
			...
			boolean isFullSet = wornArmor.containsAll(ObjectArrayList.of(
					ModItems.GECKO_ARMOR_BOOTS.get(),
					ModItems.GECKO_ARMOR_LEGGINGS.get(),
					ModItems.GECKO_ARMOR_CHESTPLATE.get(),
					ModItems.GECKO_ARMOR_HELMET.get()));
