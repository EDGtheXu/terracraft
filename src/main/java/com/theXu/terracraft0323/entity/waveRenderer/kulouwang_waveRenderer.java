package com.theXu.terracraft0323.entity.waveRenderer;
...
public class kulouwang_waveRenderer extends EntityRenderer<AbstractHurtingProjectile> {
    ...
    public kulouwang_waveRenderer(EntityRendererProvider.Context pContext) {
        super(pContext);
    }
