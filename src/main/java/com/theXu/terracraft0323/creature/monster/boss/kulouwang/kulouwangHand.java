...
public class kulouwangHand extends Monster implements GeoEntity {

    public kulouwangHand(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    }
    kulouwang owner;
    boolean mainHand;

    public kulouwangHand(kulouwang owner,Level level,boolean mainHand){
        super(ModEntities.KU_LOU_WANG_HAND.get(), level);
        this.owner = owner;
    ...
    public void tick(){
        ...
        if(owner.handState == kulouwang.HandState.follow){
